CREATE OR REPLACE FUNCTION export_request_activity_parties_stage(
  ...
  , arg_end_date varchar
    ...
    AS $$
        ...
        FROM RAW.HORIZON_STAGE.HZN_REQUEST_REQUEST r
            JOIN RAW.HORIZON_STAGE.HZN_REQUEST_REQUEST_ACTIVITY ra ON r.ID = ra.REQUEST_ID
            JOIN RAW.HORIZON_STAGE.HZN_REQUEST_REQUEST_ACTIVITY_PARTY rap ON ra.id = rap.REQUEST_ACTIVITY_ID
            JOIN RAW.HORIZON_STAGE.HZN_REQUEST_REQUEST_PARTY rp on rp.id = rap.REQUEST_PARTY_ID
